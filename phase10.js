...
export function registerPhase10({ app }) {
  const middleware = async (req, res, next) => {
    ...
    try {
      ...
      const field = `<div class="field"><label for="student_name">तुमचे नाव <span class="hint">फक्त Private Authority पाहू शकते</span></label><input id="student_name" maxlength="120" required placeholder="तुमचे पूर्ण नाव"></div>`;
      ...
      html = html.replace('नाव, मोबाईल किंवा रोल नंबर देण्याची गरज नाही.', 'तुमचे नाव फक्त Private Authority साठी सुरक्षित ठेवले जाईल; Admin किंवा Higher Authority ला ते दिसणार नाही.');
